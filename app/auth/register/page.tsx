    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-navy-900 via-navy-800 to-navy-700 flex items-center justify-center p-4">
        <div className="w-full max-w-md bg-white rounded-3xl shadow-2xl p-10 text-center">
          ...
          <h2 className="font-playfair text-2xl font-bold text-navy-800 mb-2">Welcome to the Empire!</h2>
    ...
    <div className="min-h-screen bg-gradient-to-br from-navy-900 via-navy-800 to-navy-700 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="font-poppins text-navy-200 text-sm mt-4">Join the Empire today</p>
        </div>

        <div className="bg-white rounded-3xl shadow-2xl p-8">
          <h2 className="font-playfair text-2xl font-bold text-navy-800 mb-6 text-center">Create Account</h2>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full pl-10 pr-4 py-3 border rounded-xl text-sm font-poppins outline-none transition-colors ${errors.full_name ? 'border-red-300' : 'border-gray-200 focus:border-navy-400'}`}
                />
              </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full pl-10 pr-4 py-3 border rounded-xl text-sm font-poppins outline-none transition-colors ${errors.confirm_password ? 'border-red-300' : 'border-gray-200 focus:border-navy-400'}`}
                />
              </div>
          ...
          <div className="mt-6 text-center">
            <p className="font-poppins text-xs text-gray-500">
              ...
              <Link href="/auth/login" className="text-navy-800 font-semibold hover:text-pink-500 transition-colors">
                Sign In
              </Link>
            </p>
          </div>
